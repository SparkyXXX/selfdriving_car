    ...
    def spin(self):
        ...
        if ret == True:
            ...
            try:
                ...
                x1 = 640
                dis1 = abs(x0 - x1)
                cv2.putText(binary_warped, "* dist_to_lane:" + str(dis), (640, 718), cv2.FONT_HERSHEY_SIMPLEX, 1,
                            (255, 0, 255), 2)
                cv2.putText(binary_warped, "# dist_to_point:" + str(dis1), (640, 688), cv2.FONT_HERSHEY_SIMPLEX, 1,
                            (255, 0, 255), 2)
